...
class SelectReceiverContactScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _SelectReceiverContactScreenState();
}

class _SelectReceiverContactScreenState extends ConsumerState<SelectReceiverContactScreen> {
        ...
        Expanded(
          ...
          child: Consumer(
            builder: (consumerContext, ref, child) {
              ContactsListState state = ref.watch(contactsListStateProvider(context));
  ...
  void _onChangedText(String value) {
    ref.read(contactsListStateProvider(context).notifier).getSearchedContactsList(value);
  }
}
