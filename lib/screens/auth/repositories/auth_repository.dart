import 'package:chat_app/utils/common/widgets/helper_widgets.dart';
...
class AuthRepository {
  ...
  Stream<app.User> getReceiverUserData(String receiverUserId) {
    return _firestore.collection(StringsConsts.usersCollection).doc(receiverUserId).snapshots().map(
